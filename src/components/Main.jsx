    ...
    <div className="shadow-lg p-16 mb-5 bg-body rounded">
      <div class="flex justify-center ">
        <div class="flex flex-col justify-center items-center bg-slate-100 max-w-7xl">
          <div class="text-3xl text-green-600 font-bold mt-4 ">หลักสูตรรัฐประศาสนศาสตร์</div>
          <div class="text-2xl text-black font-bold mt-2 ">
          ...
          <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
            <div class="flex flex-col justify-center items-center p-10 bg-white shadow w-[90%] md:w-[70%] lg:w-[30%] overflow-hidden">
              ...
              <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   ">
                1. Best Components
              </h1>
              <p class="text-black mt-3 text-center w-[90%] lg:w-[100%]">
                {" "}
              ...
              <h1 class="text-lg font-semibold text-green-600 uppercase mt-1">
                mark warner
              </h1>
              <h1 class="text-lg font-semibold text-black uppercase -mt-1">
                ceo / director
              </h1>
            </div>
            <div class="flex flex-col justify-center items-center p-10 bg-white shadow w-[90%] md:w-[70%] lg:w-[30%] overflow-hidden">
